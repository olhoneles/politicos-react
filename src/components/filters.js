        ...
        <div className="filter-row row">
          <div className="col-lg-6">
            <Multiselect
              ...
              onChange={selectedPoliticalParties =>
          ...
          <div className="col-lg-6">
            <Multiselect
              ...
              onChange={selectedPoliticalOffices =>
